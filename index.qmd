...
::: footer
*Local Computations with Probabilities on Graphical Structures and their Application to Expert Systems* by S. L. LAURITZEN and D. J. SPIEGELHALTER (1988)
:::
...
2. More generally, given a set of random variables and their joint density,
...
```{julia}
#| output-location: fragment
compile_algo("asia/asia.uai",
             uai_evid_filepath="asia/asia.uai.evid",
             td_filepath = "asia/asia.td",
...
::: {.column width="40%"}
![](figures/partial-evaluation-messages/output-1.svg){width=100% fig-align="center"}
:::
...
::: {.column width="40%"}
![](figures/partial-evaluation-messages/output-2.svg){width=100% fig-align="center"}
:::
